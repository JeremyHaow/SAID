...
def get_args_parser():
    ...
    parser.add_argument('--resnet_path', default="/root/lanyun-tmp/workspace/AIDE/pretrained/resnet50-19c8e357.pth", type=str, metavar='MODEL',
                        help='Path of resnet model')
    parser.add_argument('--convnext_path', default="/root/lanyun-tmp/workspace/AIDE/pretrained/open_clip_pytorch_model.bin", type=str, metavar='MODEL',
    ...
    # Dataset parameters
    parser.add_argument('--data_path', default='/root/lanyun-tmp/datasets/ProGAN/train', type=str,
                        help='dataset path')
    parser.add_argument('--nb_classes', default=2, type=int,
                        help='number of the classification types')
    parser.add_argument('--output_dir', default='/root/lanyun-tmp/workspace/AIDE/results/WTConv_ghe_score_patch_128',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='/root/lanyun-tmp/workspace/AIDE/results/WTConv_ghe_score_patch_128/tensorboard_log',
    ...
    parser.add_argument('--eval_data_path', default='/root/lanyun-tmp/datasets/ProGAN/val', type=str,
